                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" class="form-control @error('financing_amount') is-invalid @enderror" 
                                       id="financing_amount" name="financing_amount" value="{{ old('financing_amount') }}">
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" class="form-control @error('trade_in_value') is-invalid @enderror" 
                                       id="trade_in_value" name="trade_in_value" value="{{ old('trade_in_value') }}">
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('payment_method') is-invalid @enderror" id="payment_method" name="payment_method" required>
                                ...
                                <option value="lease" {{ old('payment_method') == 'lease' ? 'selected' : '' }}>Lease</option>
                            </select>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                      id="notes" name="notes" rows="3" placeholder="Additional notes about the sale...">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
